...
struct nvshmemt_libfabric_peer_pending_acks {
    ...
    uint16_t total_pending() const { return range_count + amo_ack_count; }
};
 ...
 */
#define NVSHMEMT_LIBFABRIC_ACK_AGGREGATOR_FLUSH_THRESHOLD 64
...
struct nvshmemt_libfabric_ack_aggregator {
    ...
    nvshmemt_libfabric_ack_aggregator(int npes) : pending_per_peer(npes)
    {
